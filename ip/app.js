...
const maps =
  "https://www.google.com/maps/embed/v1/place?key=AIzaSyCahhqGFfzuUx1UW-tUfJR7gj2R3iFr0-0&q=";
...
window.onload = function getIpInfo() {
  ...
  fetch("https://justcors.com/l_86lhbadshe/http://ip-api.com/json/" + resolveIP)
    ...
    .then((data) => {
      console.log(data);
      let output =
        '<h1 class="display-2 mb-4 text-white text-center">IP Info<row class="d-flex"></row></h1>';
