...
class ParticleSystem {
  constructor(params) {
    const uniforms = {
      diffuseTexture: {
        value: new THREE.TextureLoader().load("./assets/char.png"),
      },
      pointMultiplier: {
        value:
          window.innerHeight /
          (2.0 * Math.tan((0.5 * 160.0 * Math.PI) / 180.0)),
      },
    };
    ...
    for (let i = 0; i < n; i++) {
      ...
      this._particles.push({
        position: new THREE.Vector3(
          (Math.random() * 2 - 1) * 1.0,
          (Math.random() * 2 - 1) * 100.0,
          (Math.random() * 2 - 1) * 1.0
        ),
        size: (Math.random() * 0.5 + 0.5) * 8.0,
...
class ParticleSystemDemo {
  ...
  _Initialize() {
    ...
    this._camera.position.set(250, 250, 0);
    ...
    const texture = loader.load([
      "./assets/background/bg2-1.jpg",
      "./assets/background/bg2-1.jpg",
      "./assets/background/bg3-1.jpg",
      "./assets/background/bg3-2.jpg",
      "./assets/background/bg4-1.jpg",
      "./assets/background/bg4-2.jpg",
    ]);
  ...
  _LoadModel() {
    ...
    loader.load("./assets/gtv/scene.gltf", (gltf) => {
